...
function render(variables = {}) {
  ...
  if (!variables.name) variables.name = "Morgorth";
  if (!variables.lastName) variables.lastName = "The Awesome";
  if (!variables.role) variables.role = "Dungeon Master";
  if (!variables.city) variables.city = "Mordor";
  if (!variables.country) variables.country = "Middle Earth";
  if (!variables.twitter)
    variables.twitter = "https://twitter.com/4geeksacademy";
  if (!variables.github) variables.github = "https://github.com/4geeksacademy";
